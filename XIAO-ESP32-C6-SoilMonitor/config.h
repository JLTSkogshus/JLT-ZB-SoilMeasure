...
#define ADC_TRIM_SAMPLES    10   // Middle readings to average after sorting (trimmed mean)
...
#define FORCE_AWAKE_ON_FLASH       1   // 1: always clear sleep_enabled in NVS on boot (safe for flashing/OTA); set to 0 to allow z2m to control sleep
...
#define OTA_RUNNING_VERSION    0x01030900u   // v1.3.9.0 – store sleep_en as uint32 (bool NVS bug on ESP32-C6)
